                ...
                <div class="panel">
                    <div class="panel-body">
                        <div class="caption">
                            ...
                            <img src="{{"../../storage/app/public/" . $listing->imagePath}}">
                            @if(Auth::User())
                                <div align="right">
                                    <div style="width:150px">
                                        <button data-toggle="modal" data-target="#myModal"
                                                class="btn btn-primary btn-md btn-block"><span
                                                    class="glyphicon glyphicon-envelope"></span> Contact Seller
                                        </button>
                                    </div>
                                    <div style="width:150px">
                                        <button data-toggle="modal" data-target="#myReportModal"
                                                class="btn btn-primary btn-md btn-block"><span
                                                    class="glyphicon glyphicon-envelope"></span> Report Listing
                                        </button>
                                    </div>
                                </div>
                            @endif
